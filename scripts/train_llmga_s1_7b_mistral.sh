...
MODEL_VERSION="mistral_instruct"

deepspeed --master_port=7001 llmga/llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path ./base_models/Mistral-7B-Instruct-v0.2 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/llmga-mistral-pretrain/mm_projector.bin \
