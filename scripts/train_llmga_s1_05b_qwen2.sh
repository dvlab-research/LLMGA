MODEL_VERSION="Qwen2-0.5B"

deepspeed --master_port=7001 llmga/llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path ./base_models/LLM/Qwen2-0.5B-Instruct \
    --version qwen_2 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/llmga-Qwen2-0.5B-pretrain/mm_projector.bin \
