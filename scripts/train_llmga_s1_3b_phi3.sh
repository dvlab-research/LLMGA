...
MODEL_VERSION="Phi-3-mini-128k"

deepspeed --master_port=7001 llmga/llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path ./base_models/Phi-3-mini-128k-instruct \
    --version phi_3 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/llmga-Phi-3-mini-128k-pretrain/mm_projector.bin/mm_projector.bin \
