...
class InpaintingDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        list_inpainting_dict = json.load(open(data_path, "r"))
        rank0_print("Formatting inputs...Skip in lazy mode")
        self.tokenizer = tokenizer
        self.list_inpainting_dict = list_inpainting_dict
        self.len_inpainting = len(self.list_inpainting_dict)
        self.gen_mask = get_mask_generator()


    def __len__(self):
        return self.len_inpainting


    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        tp = self.list_inpainting_dict[i].copy()
